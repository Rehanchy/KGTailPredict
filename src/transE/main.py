...
from transE import LossRate_E, TransE
...
train_model_save_str = "./output/transEtraine2.bin"
...
def train():
    ...
    if not os.path.isfile(train_model_save_str):
        model = TransE(entity_pre_embedded["word2index"],
        ...
        model = TransE(entity_word2index,
                        relation_word2index,
                        embed_dimension = dimension)
    ...
    for epoch in range(epoch_range):
        ...
        curr_score = 0.3 * hit_1_acc + 0.7 * hit_5_acc   # hit@5 most important
